...
func _enter_tree():
	SignalManager.show_game_over.connect(gameOver)

func _ready():
	sat = $Desat.material.get("shader_parameter/saturation")
	vignet = $Vignette.material.get("shader_parameter/vignette_opacity")
	$Desat.material.set("shader_parameter/saturation", 1.0)
...
func gameOver():
	...
	tween.tween_property($Desat.material, "shader_parameter/saturation", sat, 0.1)
